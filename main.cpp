...
int main(int argc, char **argv) {
	...
	if (arg.gui) cout << "Using GUI" << endl;
	if (arg.write) cout << "Writing to file" << endl;
	if (arg.host) cout << "Hostname: " << arg.hostname << endl;
	if (arg.port) cout << "Port number: " << arg.portno << endl;
	if (arg.cam) cout << "Using cameras: " << arg.camera1 << arg.camera2 << endl;
	if (arg.file) cout << "Using files: " << arg.filename1 << arg.filename2 << endl;
